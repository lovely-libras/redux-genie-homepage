    ...
    return (
      <div>
        <h1>Please enter your models property names and thier types</h1>
          <input placeholder="Feathers, isQuacking, etc"onChange={this.handleChange} type="text" name="property_name" placeholder="Property Name" value={this.state.property_name}/>
          <select onChange={this.handleChange} name="property_value" value={this.state.property_value}>
            <option value="">----</option>
